    ...
    <>
        <div className="poppins text-gray-800 flex flex-col items-center justify-center mt-7">
            ...
            <div className="flex flex-col items-center justify-center gap-10 lg:gap-15 lg:flex-row w-full mx-auto text-center">
                <Box number={1} emoji="📸" header="Snap or Upload" text="Take a photo with your phone or upload one from your laptop. Works with anything - plants, objects, text, even memes." />
                <Box number={2} emoji="🤖" header="AI Analysis" text="Opsis sends the image to an AI model. It looks at shapes, colors, text, and context to figure out what it is." />
                <Box number={3} emoji="✨" header="Get Instant Info" text="You get a clear result in seconds: what it is, key details, and useful info. No guessing, no Googling for 10 mins! :)" />
            </div>
